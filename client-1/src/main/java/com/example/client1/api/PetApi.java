...
public interface PetApi {
    ...
    @RequestMapping(value = "/pet/{petId}",
        ...
        method = RequestMethod.POST)
    default ResponseEntity<Void> _updatePetWithForm(@ApiParam(value = "ID of pet that needs to be updated",required=true) @PathVariable("petId") Long petId,@ApiParam(value = "Updated name of the pet") @RequestPart(value="name", required=false)  String name,@ApiParam(value = "Updated status of the pet") @RequestPart(value="status", required=false)  String status) {
    ...
    @RequestMapping(value = "/pet/{petId}/uploadImage",
        ...
        method = RequestMethod.POST)
    default ResponseEntity<ModelApiResponse> _uploadFile(@ApiParam(value = "ID of pet to update",required=true) @PathVariable("petId") Long petId,@ApiParam(value = "Additional data to pass to server") @RequestPart(value="additionalMetadata", required=false)  String additionalMetadata,@ApiParam(value = "file to upload") @Valid @RequestPart(value = "file") MultipartFile file) {
