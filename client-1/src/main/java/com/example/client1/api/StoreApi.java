...
import com.example.client1.model.Order;
...
public interface StoreApi {
    ...
    default ResponseEntity<Void> _deleteOrder(@Min(1L)@ApiParam(value = "ID of the order that needs to be deleted",required=true) @PathVariable("orderId") Long orderId) {
    ...
    default ResponseEntity<Order> _getOrderById(@Min(1L) @Max(10L) @ApiParam(value = "ID of pet that needs to be fetched",required=true) @PathVariable("orderId") Long orderId) {
